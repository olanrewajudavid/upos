<?php
	include('../connect.php');
	$id=$_GET['id'];
	$result = $db->prepare("SELECT * FROM supliers WHERE suplier_id= :supplierid");
...
<button class="btn btn-success btn-block btn-large" style="width:267px;" type="submit"><i class="icon icon-save icon-large"></i> Save Changes</button>
</div>
</div>
</form>
<?php
