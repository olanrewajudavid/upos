...
<center>
<input type="text" size="25" value="" name="cname" id="country" onKeyUp="suggest(this.value);"  class="" autocomplete="on" placeholder="Enter Customer Name" style="width: 268px; height:30px;" />
