...
<form action="salesreport.php" method="get" style="color:inherit;">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
            ...
            onClick="window.open('preview_archive.php?invoice=<?php echo $row['invoice_number'];?>&cname=<?php echo $row['name'];?>', 'newwindow', 'width=1200, height=600');
            return false"><button  style="float:none;" class="btn btn-success btn-mini">Print</button></a></td>
			</tr>
			<?php
				}
			?>
